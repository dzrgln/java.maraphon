...
//
//        System.out.println("Введи координаты второго однопалубного коробля (формат x1,y1)");
//        Ship singleDeck2 = new Ship() {};
//        singleDeck2.addShip(battlefield, 1);
//        shipsOfFleet.add(singleDeck2.getPointsOfShip());
//        battlefield.printBattlefield();
//
//        System.out.println("Введи координаты третьего однопалубного коробля (формат x1,y1)");
//        Ship singleDeck3 = new Ship() {};
//        singleDeck3.addShip(battlefield, 1);
//        shipsOfFleet.add(singleDeck3.getPointsOfShip());
//        battlefield.printBattlefield();
//
//        System.out.println("Введи координаты последнего однопалубного коробля (формат x1,y1)");
...
//        battlefield.printBattlefield();
//
//        System.out.println("Введи координаты последнего двухпалубного коробля (формат x1,y1;x2,y2)");
